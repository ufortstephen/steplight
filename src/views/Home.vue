                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-lg-6 banner-info-bg">
                        ...
                        <a
                          class="
                            btn btn-style btn-outline-light
                            mt-sm-5 mt-4
                            mr-2
                          "
                          href="about.html"
                      ...
                      <div
                        class="col-lg-5 col-md-8 img offset-lg-1 mt-lg-0 mt-4"
                      >
                        <img
          ...
          <div class="row">
            <div class="col-lg-7 mb-lg-0 mb-md-5 mb-4 align-self">
              <h3 class="title-left mx-0">
                Our bank founded in 2020 to introduce the new level of financial
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="work-grids">
              ...
              <div class="content">
                ...
                <p class="desc">Register and Create Account Online.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 mt-sm-0 mt-5">
            <div class="work-grids">
              ...
              <div class="content">
                ...
                <p class="desc">Fill Out or Form.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 mt-lg-0 mt-5">
            <div class="work-grids">
              ...
              <div class="content">
                ...
                <p class="desc">Sign an Agreement.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 mt-lg-0 mt-5">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="grids5-info">
                ...
                <div class="blog-info">
                  <h4>
                    <a href="#blog-single"
                      >7 Banking services that can save retirees money</a
                    >
                  </h4>
                  <p class="date">
                    <span class="fa fa-calendar mr-2"></span> September 17, 2020
                  </p>
                  <p>7 Banking services that can save retirees money!</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
              <div class="grids5-info">
                ...
                <div class="blog-info">
                  <h4>
                    <a href="#blog-single"
                      >8 Ways to Drive Adoption of Your Banking App</a
                    >
                  </h4>
                  <p class="date">
                    <span class="fa fa-calendar mr-2"></span> September 17, 2020
                  </p>
                  <p>8 Ways to Drive Adoption of Your Banking App!</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
              <div class="grids5-info">
                ...
                <div class="blog-info">
                  <h4>
                    <a href="#blog-single"
                      >How is it progressing and what will 2020 bring?</a
                    >
                  </h4>
                  <p class="date">
                    <span class="fa fa-calendar mr-2"></span> September 17, 2020
                  </p>
                  <p>How is it progressing and what will 2020 bring?!</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row footer-top-29">
            <div class="col-lg-4 col-md-6 footer-list-29 footer-1 pr-lg-5">
              <div class="footer-logo mb-4">
                ...
                <span class="ml-3">STEPLIGHT BANK</span>
              </div>
              <p>
                It is the leading financial establishment providing high-quality
                international banking services. Our success is attributed to our
                loyal customers. We provide reliable services for you.
              </p>
            </div>
            <div
              class="
                col-lg-2 col-md-6 col-sm-5 col-5
            ...
            <div
              class="
                col-lg-3 col-md-6 col-sm-7 col-7
            ...
            >
              ...
              <p class="mb-3">
                3040 Davis Rd #45 Fairbanks, Alaska (AK), 99709
              </p>
              <p class="mb-2">
                <span class="fa fa-phone"></span>
                <a href="tel:+1(21) 234 4567">xxx-xx- </a>
              </p>
              <p class="mb-2">
                <span class="fa fa-envelope-o"></span>
                <a href="mailto:steplightbank@mail.com">sb@mail.com</a>
              </p>
              <p>
                <span class="fa fa-support"></span>
            ...
            <div class="col-lg-3 col-md-6 footer-list-29 footer-4 mt-lg-0 mt-5">
              ...
              <div class="post1 mt-4">
                <a href="#url" class="post-title"
                  >Stocks Could Surge 10% between Now And 2020</a
                >
                <p class="small">September 28, 2020</p>
              </div>
            </div>
      ...
      <section class="w3l-copyright text-center">
        <div class="container">
          <p class="copy-footer-29">
            © 2020 Steplight Bank. All rights reserved.
          </p>
        </div>
