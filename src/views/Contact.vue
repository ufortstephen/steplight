<template>
  <div>
    ...
    <div class="w3l-contact-info py-5" id="contact" style="background: #f7f7f7">
      <div class="container py-lg-5 py-md-4">
        <div class="title text-center">
          <h3 class="title-big">Get in touch with us</h3>
          <p class="mt-2 mx-lg-5">
            ...
            <div class="contact-infos">
              <div class="single-contact-infos">
                ...
                <div class="text-box">
                  ...
                  <p>3040 Davis Rd #45 Fairbanks, Alaska (AK), 99709.</p>
                </div>
              </div>
              <div class="single-contact-infos">
                ...
                <div class="text-box">
                  ...
                  <p><a href="tel:+1(xx) 234 4567">+234 xx xxx xxx</a></p>
                </div>
              </div>
              <div class="single-contact-infos">
                ...
                <div class="text-box">
                  ...
                  <p>
                    <a href="mailto:steplightbank@support.com"
                      >steplightbank@support.com</a
                    >
                  </p>
                </div>
              </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6 form-inner-cont mt-lg-0 mt-sm-5 mt-4">
            <form class="signin-form" @submit.prevent="sendContactMsg()">
        ...
        <div class="container py-lg-4">
          <div class="row footer-top-29">
            <div class="col-lg-4 col-md-6 footer-list-29 footer-1 pr-lg-5">
              ...
              <p>
                StepLight Bank is the leading financial establishment providing
                high-quality international banking services. Our success is
                attributed to our loyal customers. We provide reliable services
                for you.
              </p>
            </div>
            <div
...
export default {
  title: "Steplight Bank - Contact Us.",
  name: "Home",
  components: {
    HelloWorld,
    appheader,
  ...
  methods: {
    async sendContactMsg() {
      try {
        const response = await api.sendContactMessage(this.message);
        this.$message({
          showClose: true,
          message: "Congrats, message sent.",
          type: "success",
        });
