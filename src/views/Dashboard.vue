              ...
              <div class="col-md-6 grid-margin transparent">
                <div class="row py-4">
                  <div class="col-md-8">
                    ...
                    <h6 class="mb-4">888 888 888 888 888</h6>
                  ...
                  <div class="col-md-4">
                    ...
                    <h2>88.90 <span class="text-muted"> $</span></h2>
                  </div>
                </div>
                <!-- <div class=" row ">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="font-weight-500">
                      The total number of transactions within the date range. It
                      is the period time a user is actively engaged with
                      transactions.
                    </p>
                    <div class="d-flex flex-wrap mb-5">
                      <div class="mr-5 mt-3">
                        <p class="text-muted">Amount Sent</p>
                        <h3 class="text-primary fs-30 font-weight-medium">
                          12.3k
                        </h3>
                      </div>
                      <div class="mr-5 mt-3">
                        <p class="text-muted">Amount Recieved</p>
                        <h3 class="text-primary fs-30 font-weight-medium">
                          14k
                        </h3>
                      </div>
                      ...
                      <div class="mt-3">
                        <p class="text-muted">Overdraft</p>
                        <h3 class="text-primary fs-30 font-weight-medium">
                          14k
                        </h3>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <p class="card-title">Account Report</p>
                      <a href=" # " class="text-info">View all</a>
                    </div>
                    <p class="font-weight-500">
                      The total number of transactions within the date range. It
                      is the period time a user is active.
                    </p>
                    <div
                      id=" sales-legend "
